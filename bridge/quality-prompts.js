...
function buildRegionAuditPrompt(candidate) {
  return [
    "너는 일본 만화 이미지 OCR·한일 번역·한국어 레터링의 독립적인 2차 검수자다.",
    ...
    "original에 오독이 보이면 먼저 바로잡고, translated는 화자의 말투·존댓말·감정·말버릇·인물 관계와 앞뒤 문맥이 자연스럽도록 교정하라.",
    "직역투를 피하되 의미, 뉘앙스, 고유명사, 숫자, 말줄임표, 감탄과 의성어를 임의로 생략하거나 덧붙이지 말고 여러 영역의 이름과 용어를 일관되게 번역하라.",
    "regionKind=sfx는 원문의 소리, 강도, 반복감과 장면 분위기를 살린 짧은 한국어 의성어·의태어로 옮기고 장식 효과음을 설명문으로 길게 풀지 마라.",
