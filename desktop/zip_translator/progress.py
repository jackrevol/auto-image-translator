...
def _classify_message(message: str) -> tuple[str, str, bool]:
    rules = (
        ...
        ("정밀 판독·초벌 번역 1/3", "1/3 판독·번역", "running", False),
        ("누락·좌표·번역 통합 검수 2/3", "2/3 통합 검수", "running", False),
        ("안전 필터 차단 · 크롭", "로컬 대체 식질", "running", False),
        ("Codex 대사 작업 시트", "Codex 작업 시트", "running", False),
        ("Codex 대사 크롭", "영역 재조립", "running", False),
        ("Codex 대사 영역", "Codex 영역 렌더", "running", False),
        ("Codex 이미지 생성 안전 필터", "안전 필터 차단", "error", True),
        ...
        ("합성 결과 시각 검수 3/3", "3/3 시각 검수", "running", False),
        ("시각 검수 생략", "검수 생략", "running", False),
        ("시각 검수 통과본", "최종 결과 재사용", "running", False),
